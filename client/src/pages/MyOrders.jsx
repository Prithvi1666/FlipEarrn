...
import { CheckCheck, CheckCircle2, ChevronDown, ChevronUp, Loader2Icon } from 'lucide-react';
                        ...
                        {Object.entries(credential).map(([key, value])=>(
                          <div key={key} className='flex items-center justify-between bg-gray-50 p-3 rounded-lg'>
                            ...
                            <div className='flex items-center gap-2'>
                              <span className='text-sm text-gray-600'>{mask(value, key)}</span>
                              <button onClick={()=> copy(value)} className='p-1 hover:bg-gray-200 rounded transition text-gray-500 hover:text-gray-700'>
