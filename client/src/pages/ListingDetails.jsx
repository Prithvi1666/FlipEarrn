...
import { ArrowLeftIcon, ArrowUpRightFromSquareIcon, Calendar, CheckCircle2, 
  ChevronLeftIcon, ChevronRightIcon, DollarSign, Eye, LineChart, Loader2Icon, MapPin, MessageSquareMoreIcon, 
  ShoppingBagIcon, User } from 'lucide-react';
  ...
  return listing ? (
    <div className='max-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex-1'>
              ...
              <div className='bg-white rounded-xl border border-gray-200 mb-5'>
                ...
                <div className='grid grid-cols-2 md:grid-cols-4 gap-4 p-4 text-center'>
                  <div>
                    ...
                    <p className='font-semibold text-gray-800 w-5 h-5 mb-1'>
          ...
          <div className='bg-white w-full md:w-[370px] md:h-fit rounded-xl border border-gray-200 p-5 max-md:mb-10'>
            ...
            <button onClick={loadChatbox} className='w-full bg-indigo-600 text-white py-2 rounded-lg hover:bg-indigo-800 transition text-sm
             font-medium flex items-center justify-center gap-2'>
              <MessageSquareMoreIcon  className='size-4'/> Chat
            </button>

            {listing.isCredentialChanged && (
              <button onClick={purchaseAccount} className="w-full mt-2 bg-purple-600 text-white py-2 rounded-lg hover:bg-purple-800 transition text-sm 
              font-medium flex items-center justify-center gap-2">
