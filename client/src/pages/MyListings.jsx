import { ArrowDownCircleIcon, BanIcon, CheckCircle, Clock, CoinsIcon, DollarSign, Edit, Eye, EyeIcon, EyeOffIcon, LockIcon, Plus, StarIcon, TrashIcon, TrendingUp, User, Users, WalletIcon, XCircle } from 'lucide-react';
...
import WithdeawModal from '../components/WithdeawModal';
...
const MyListings = () => {
 ...
 const markAsFeaturd = async (listingId) => {
    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 pt-8'>
        ...
        <div className='flex flex-col md:flex-row justify-between items-start md:items-center mb-8'>
          <div>
            ...
            <p className='text-gray-600'>Manage your social media account listinsgs</p>
          </div>
          <button onClick={()=>navigate('/create-listing')} className='bg-indigo-600 hover:bg-indigo-700
           text-white px-6 py-2 rounded font-medium flex items-center space-x-2 mt-4 md:mt-0'>
        ...
        {[
          ...
          <div onClick={()=> item.label === "Available" && setShowWithdrawal(true)} key={index} className='flex flex-1 items-center justify-between p-4 rounded-lg border border-gray-100 cursor-pointer'>
            <div className='flex items-center gap-3'>
              ...
              <span className='font-medium text-gray-600'>{item.lable}</span>
            </div>
            ...
            <div key={listing.id} className='bg-white rounded-lg border border-gray-200 hover:shadow-lg shadow-gray-200/70 transition-shadow'>
              <div className='p-6'>
                    ...
                    <div className='flex justify-between items-start'>
                      ...
                      <div className='flex items-center gap-2'>
                        ...
                        {listing.status === "active" && (
                          <StarIcon onClick={()=>markAsFeaturd(listing.id)} size={18} 
                ...
                <div className='space-y-4'>
                  <div className='grid frrid-cols-2 gap-2 text-sm'>
        ...
        {showWithdrawal && (
          <WithdeawModal onClose={()=> setShowWithdrawal(null)}/>
        )}

        {/* Footer */}
        <div className=' bg-white border-gray-200 border-t p-4 text-center mt-28'> 
        <p className='text-sm text-gray-500'>© 2025 <span className='text-indigo-600'>Prithviraj Daud</span> All rights reserved.</p> 
       </div>
    </div>
  )
}
